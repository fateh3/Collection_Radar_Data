    ...
    def run(self):
        ...
        if self.simulate:
            ...
            while not self.stopEvent.is_set():
                ...
                radarDataQ.put([currentTime] + list(radarFrame))
                radarDataLock.release()
...
class CollectionThreadX4(threading.Thread):
    def __init__(self, threadID, name, stopEvent,radarSettings, baseband = False, fs = 17, radarPort='/dev/ttyACM2', simulate = False, filePaths = None,
...
#        global radarDataQ
        if self.simulate:
            ...
            while not self.stopEvent.is_set():
                ...
                self.radarDataQ.put([currentTime] + list(radarFrame))
                self.radarDataLock.release()
